              ...
              <ul class="spost_nav">
                <?php
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    ?>
                <li>
                  <div class="media wow fadeInDown"> <a href="pages/single_page.html" class="media-left"> <img alt="" src="images/<?php echo $row['featured_img']; ?>"> </a>
                    <div class="media-body"> <a href="pages/single_page.html" class="catg_title"> <?php echo $row['title']; ?></a> </div>
                  </div>
                </li>
                  <?php
                     }
